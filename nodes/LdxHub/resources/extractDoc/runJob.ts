...
export const runJobFields: INodeProperties[] = [
	// ---------- Main parameters ----------
	{
		...
		required: true,
		description:
			'Name of the binary property from the previous node that contains the file to extract text from',
	...
	},
	{
		...
		type: 'options',
		typeOptions: {
			loadOptionsMethod: 'getExtractDocEngines',
		},
		required: true,
		default: '',
		description:
			'ExtractDoc engine to use. Click to load available engines from LDXhub. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
		displayOptions: { show: showOnlyForRunJob },
	},
	{
		...
		type: 'options',
		typeOptions: {
			loadOptionsMethod: 'getExtractDocOutputFormats',
